...
loadPath = "../data/CETUSdataset/"
savePath = "../data/CETUS/CETUS/"
...
if __name__ == "__main__":
    ...
    for i in range(45):
        subpath = "patient" + str(i).zfill(2)
        ct = sitk.ReadImage(loadPath + subpath +'/patient'+str(i).zfill(2)+'_ED.nii.gz')#读取图像地址
        lbl = sitk.ReadImage(loadPath + subpath +'/patient'+str(i).zfill(2)+'_ED_gt.nii.gz')
        print(ct)
        ...
        if CFG.do_windowing:    # ct
            ...
            new_ct_array= normalization(new_ct_array)
